  ...
  define_singleton_method :call do |plugin_class:|
    plugin_class.required_config :apply_timeout do |attribute, value, plugin|
      ::Kitchen::Config::ProcessSchemaResult
        .call attribute: attribute, plugin: plugin, result: ::Kitchen::Config::ApplyTimeout::Schema.call(value: value)
    end
