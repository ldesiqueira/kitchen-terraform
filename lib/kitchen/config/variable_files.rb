  ...
  define_singleton_method :call do |plugin_class:|
    plugin_class.required_config :variable_files do |attribute, value, plugin|
      ::Kitchen::Config::ProcessSchemaResult
        .call attribute: attribute, plugin: plugin, result: ::Kitchen::Config::VariableFiles::Schema.call(value: value)
    end
