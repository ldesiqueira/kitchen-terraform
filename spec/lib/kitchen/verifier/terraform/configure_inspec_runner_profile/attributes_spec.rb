...
require "support/kitchen/verifier/terraform/configure_inspec_runner_profile/attributes_context"
::RSpec.describe ::Kitchen::Verifier::Terraform::ConfigureInspecRunnerProfile::Attributes do
  describe ".call" do
    include_context "::Kitchen::Verifier::Terraform::ConfigureInspecRunnerProfile::Attributes.call"
