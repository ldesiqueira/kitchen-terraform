...
::RSpec.describe ::Kitchen::Verifier::Terraform do
  ...
  it_behaves_like ::Kitchen::Config::Groups do
    include_context ::Kitchen::Instance do let :verifier do described_instance end end
  end
  describe "#call(state)" do
    include_context "silent_client"
    include_context ::Kitchen::Instance
    include_context "::Kitchen::Verifier::Terraform::ConfigureInspecRunnerProfile::Attributes.call" do
